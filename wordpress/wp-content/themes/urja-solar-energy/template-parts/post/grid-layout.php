...
<div class="col-md-4 col-sm-4">
    ...
    <div class="article_content">
      ...
      <div class="article-text">
        ...
        <div class="read-btn">
          <a href="<?php echo esc_url( get_permalink() );?>" class="blogbutton-small" title="<?php esc_attr_e( 'READ MORE', 'urja-solar-energy' ); ?>"><?php esc_html_e('READ MORE','urja-solar-energy'); ?><i class="fas fa-angle-right"></i></a>
        </div>
      </div>
